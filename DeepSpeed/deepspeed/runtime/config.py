...
def get_eigenvalue_config(param_dict):
    if get_quantize_enabled(param_dict):
        ...
        assert not get_eigenvalue_enabled(
            param_dict), "Eigenvalue based MoQ is temporarily disabled"
        return (
...
class DeepSpeedConfig(object):
    ...
    def _initialize_params(self, param_dict):
        ...
        assert not (
            self.fp16_enabled and self.bfloat16_enabled), 'bfloat16 and fp16 modes cannot be simultaneously enabled'
