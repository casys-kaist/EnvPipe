...
class PipelineModule(nn.Module):
    def __init__(self,
        ...
        if checkpointable_layers is not None:
            assert isinstance(
                checkpointable_layers, list), "param `checkpointable_layers` must be type of list."
    ...
    def _partition_layers(self, method='uniform'):  # TODO IHKOO
        ...
        if method == 'uniform':
            ...
            self.parts = self._custom_partitions
            ...
            # Consider loss computation when spliting
            # Last stage should have one fewer layer than others
